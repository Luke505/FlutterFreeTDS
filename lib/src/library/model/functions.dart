...
typedef dbsetlversion_Dart = int Function(Pointer<LOGINREC> login, int version);
...
typedef dbcoltypeinfo_Dart = Pointer<DBTYPEINFO> Function(Pointer<DBPROCESS> dbproc, int column);
...
typedef dbsetlversion_Native = Int32 Function(Pointer<LOGINREC> login, Uint8 version);
...
typedef dbcoltypeinfo_Native = Pointer<DBTYPEINFO> Function(Pointer<DBPROCESS> dbproc, Int32 column);
